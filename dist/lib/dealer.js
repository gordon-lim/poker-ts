...
var Dealer = /** @class */ (function () {
     ...
     */
    Dealer.prototype.isAtStartOfBettingRound = function () {
        var _a, _b;
        assert_1.default(this.handInProgress(), 'Hand must be in progress');
        return (_b = (_a = this._bettingRound) === null || _a === void 0 ? void 0 : _a.isAtStartOfBettingRound()) !== null && _b !== void 0 ? _b : false;
    };
    /**
     ...
     * @throws {AssertionError} if no hand is in progress
     */
    Dealer.prototype.isInMiddleOfBettingRound = function () {
        var _a, _b;
        assert_1.default(this.handInProgress(), 'Hand must be in progress');
        return (_b = (_a = this._bettingRound) === null || _a === void 0 ? void 0 : _a.isInMiddleOfBettingRound()) !== null && _b !== void 0 ? _b : false;
    };
    ...
    Dealer.prototype.evaluateAndDistributePots = function () {
        ...
        if (this._potManager.pots().length === 1) {
            ...
            if (eligiblePlayersWithCards.length === 1) {
                ...
                var index = eligiblePlayersWithCards[0];
